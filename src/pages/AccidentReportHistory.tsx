    ...
    return (
        <BaseLayout>
            <div className="container mx-auto p-4 flex flex-col items-center">
                ...
                <div className="mb-4">
                    <button onClick={() => downloadPDF(data, columns)} className="mr-2 p-2 bg-blue-500 text-white rounded">Descargar PDF</button>
                    <button onClick={() => downloadCSV(data, columns)} className="p-2 bg-green-500 text-white rounded">Descargar CSV</button>
                </div>
